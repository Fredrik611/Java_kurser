...
public class Yathzee extends Application {
	...
	public void start(Stage primaryStage) throws FileNotFoundException {
		...
		// dice image
		Image dice = new Image(new FileInputStream(
				"C:\\Users\\Fredrik\\eclipse-workspace\\java_kurser\\1DV507\\src\\fa222rw_assign2\\yathzee\\dice-png.png"));
		...
		// text box used for information like how many rolls you have left and the later
		// displays the result.
	...
	private void showResult(Text txtbox) {
		...
		// if three out of the five dices is the same and the other two is also the same
		// run this code.
	...
	private boolean straight(int straight) {
		...
		Arrays.sort(result);
		// than it checks that is i + 1 or 2 (depending on which straight it checking
		// for)is equal to the array index i
	...
	private Rectangle2D uppdateImage(int diceface, int diceindex) {
		...
		// a switch case that takes the number you rolled and returns a new rectangle2d
		// that highlights that diceface in the picture
		switch (diceface) {
		case 1:
