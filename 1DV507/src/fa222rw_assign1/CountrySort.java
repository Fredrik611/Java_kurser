...
public class CountrySort {
	...
	public static void main(String[] args) {
		...
		// if s1 is bigger than s2 it will put s1 before s2 in the array. Same with the other way around
		...
		// the bigger char is later in the alphabet.
		...
		Comparator<String> countAs = (s1,s2) -> {
			// counts all the a's in the country name. s1 counts down the counter and s2 counts the counter up. 
			int cnt = 0;
